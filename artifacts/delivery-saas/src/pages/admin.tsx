...
import { useListOrders, useListDrivers, useAssignOrdersAuto, useAssignOrderManual, getListOrdersQueryKey, OrderStatus, ZoneName } from "@workspace/api-client-react";
                  ...
                  <div className="divide-y divide-border">
                    {zoneOrders.map(order => {
                      ...
                      const handleAssign = async () => {
                        ...
                        setIsAssigning(true);
                        await handleManualAssign(order.id, parseInt(selectedDriver));
                        setIsAssigning(false);
                      };

                      return (
                        <div key={order.id} className="p-4 sm:p-6 hover:bg-muted/10 transition-colors flex flex-col xl:flex-row gap-6 justify-between items-start xl:items-center">
