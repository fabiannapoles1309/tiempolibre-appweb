...
/**
 * @summary Add a 35-envÃ­o recharge block to a cliente's subscription (ADMIN/SUPERUSER)
 */
...
export const getGetDashboardUrl = () => {
  return `/api/admin/reports/dashboard`;
};
...
export const getGetDashboardQueryKey = () => {
  return [`/api/admin/reports/dashboard`] as const;
};
...
/**
 * @summary Combined Excel report (envÃ­os + cash) per cliente, grouped by period.
 */
